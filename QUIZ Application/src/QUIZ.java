...
public class QUIZ extends JFrame implements ActionListener {
    ...
    QUIZ(String name){
        ...
        ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("icon/quiz new.jpg"));
        ...
        add(image);
         ...
         qno= new JLabel(" ");
        qno.setBounds(100,400,60,30);
        qno.setFont(new Font("Tahoma",Font.PLAIN,24));
        add(qno);

         question= new JLabel(" ");
        question.setBounds(170,400,900,30);
        ...
        LIFELINE.setFont(new Font("dialog",Font.PLAIN,22));
    ...
    public void paint(Graphics g){
        ...
        if(timer > 0) {
            g.drawString(time, 1030, 500);
        }else {
            g.drawString("times upp " ,1030, 500);
